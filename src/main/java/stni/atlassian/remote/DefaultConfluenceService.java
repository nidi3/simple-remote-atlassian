...
public class DefaultConfluenceService implements ConfluenceService{
  ...
  private final stni.atlassian.remote.ConfluenceTasks confluenceTasks;
  public DefaultConfluenceService(String baseUrl, String username, String password){
    ...
    try{
      ...
      confluenceTasks = new stni.atlassian.remote.ConfluenceTasks(this);
    }catch(Exception e){
  ...
  public stni.atlassian.remote.ConfluenceService getService(){
    try{
