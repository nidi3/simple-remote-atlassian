...
public class JiraRestService {
    ...
    public List<IssueLinkType> getIssueLinkTypes() throws IOException, JiraRestException {
    ...
    public void linkIssues(IssueLink issueLink) throws IOException, JiraRestException {
        access.executePost("issueLink", issueLink);
    }

    public InputStream loadAttachment(RemoteAttachment attachment) throws IOException, JiraRestException {
    ...
    public List<RemoteProject> getAllProjects() throws IOException, JiraRestException {
    ...
    public List<RemoteProject> getProjectsByKey(String... keys) throws IOException, JiraRestException {
    ...
    public List<Map<String, Object>> getAllIssuesByJql(String jql, String fields, String expand) throws IOException, JiraRestException {
    ...
    public List<Map<String, Object>> getIssuesByJql(String jql, int startAt, int maxResults, String fields, String expand) throws IOException, JiraRestException {
