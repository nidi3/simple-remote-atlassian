...
public class DefaultJiraService implements JiraService{
  ...
  private final stni.atlassian.remote.jira.rest.JiraRestService jiraRestService;
  private final stni.atlassian.remote.jira.JiraTasks jiraTasks;
  public DefaultJiraService(String baseUrl, String username, String password){
    ...
    try{
      ...
      jiraRestService = new stni.atlassian.remote.jira.rest.JiraRestService(baseUrl, username, password);
      jiraTasks = new stni.atlassian.remote.jira.JiraTasks(this);
    }catch(Exception e){
  ...
  public com.atlassian.jira.rpc.soap.beans.RemoteIssue getIssue(java.lang.String string1){
    try{
      return service.getIssue(token,string1);
  ...
  public com.atlassian.jira.rpc.soap.beans.RemoteIssue[] getIssuesFromFilter(java.lang.String string1){
    try{
      return service.getIssuesFromFilter(token,string1);
  ...
  public java.util.List<stni.atlassian.remote.jira.rest.IssueLinkType> getIssueLinkTypes(){
    try{
  ...
  public void linkIssues(stni.atlassian.remote.jira.rest.IssueLink issueLink0){
    try{
  ...
  public stni.atlassian.remote.jira.JiraService getService(){
    try{
