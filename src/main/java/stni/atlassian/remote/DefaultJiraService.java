...
public class DefaultJiraService implements JiraService{
  ...
  private final stni.atlassian.remote.rest.JiraRestService jiraRestService;
  private final stni.atlassian.remote.JiraTasks jiraTasks;
  public DefaultJiraService(String baseUrl, String username, String password){
    ...
    try{
      ...
      jiraRestService = new stni.atlassian.remote.rest.JiraRestService(baseUrl, username, password);
      jiraTasks = new stni.atlassian.remote.JiraTasks(this);
    }catch(Exception e){
  ...
  public java.util.List<stni.atlassian.remote.rest.IssueLinkType> getIssueLinkTypes(){
    try{
  ...
  public void linkIssues(stni.atlassian.remote.rest.IssueLink issueLink0){
    try{
  ...
  public stni.atlassian.remote.JiraService getService(){
    try{
