...
import stni.atlassian.remote.rest.IssueLink;
...
public class JiraTasks {
    ...
    public RemoteIssue createRequirementAndFeature(RemoteProject project, String summary, String description) throws RemoteException {
        ...
        feature = service.createIssueWithSecurityLevel(feature, Long.parseLong(securityLevelByName(project, "mimacom security level").getId()));
